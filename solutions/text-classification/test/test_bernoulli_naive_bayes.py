...
from part1.bernoulli_naive_bayes import BernoulliNaiveBayes
...
class TestNaiveBayes(unittest.TestCase):
    ...
    def test_class_feature_counts(self):
        self.assertEqual(
            self.nb.class_feature_counts['knot-tying']['fishing'], 0)
        self.assertEqual(
            self.nb.class_feature_counts['fishing']['document'], 1)
